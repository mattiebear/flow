defmodule FlowWeb.CoreComponents do
  ...
  def error(assigns) do
    ~H"""
    <p class="mt-1 flex gap-3 text-sm leading-6 text-red-700 dark:text-red-300 text-sm">
  ...
  def menu_option(assigns) do
    styles =
      case assigns.variant do
        "default" -> ""
        "destructive" -> "text-red-500 hover:bg-red-500 hover:text-zinc-100"
      end
